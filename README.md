...
An editorial portfolio site (home, resume, and project case studies backed by MDX). It exists partly as a **hands-on exercise** in **React 19’s `<ViewTransition>`** and **Next.js 16.2** navigation integration: page changes feel directional and continuous instead of an abrupt repaint, and repeated UI (photo, name, copy) **morphs** between routes when it makes sense.
